...
type TranslationKey =
  ...
  // 2026-07-14 主人拍: 搜索无结果/加载失败 的友好提示
  | 'productLibraryNoResults' | 'productLibraryNoResultsHelp' | 'productLibraryLoadFailed' | 'productLibraryRetry' | 'productLibraryClearFilters';
...
const TRANSLATIONS: Record<UiLanguage, Record<TranslationKey, string>> = {
  ...
  zh_hans: {
    ...
    product_library: '产品库', productLibraryEmpty: '目前没有产品', productLibraryEmptyHelp: 'prompt-cms 同步尚未返回任何产品，请稍候再试。', spec: '规格', sellingPoints: '卖点', productImages: '图片', pasteImage: '粘贴图片', dropImage: '拖拽图片到此处', uploadImage: '上传图片', uploadHint: '可拖拽文件、粘贴 (⌘V)，或点击选择', setCover: '设为封面', removeCover: '取消封面', deleteImage: '删除', deleteConfirm: '删除这张图？', uploading: '上传中…', coverBadge: '封面', noImagesPlaceholder: '尚未上传任何图片', viewGrid: '网格', viewTimeline: '时间线', viewToggleAria: '视图切换', imageCountShort: '张', imageCompression: '上传压缩', imageCompressionHelp: '默认开，关则不重编码。', on: '开', off: '关', productsShown: '个产品', productsShownHelp: '产品库总数量', searchClear: '清除搜索',
    productLibraryNoResults: '没有匹配的產品', productLibraryNoResultsHelp: '试试更换关键字、清除筛选，或新增一个产品。', productLibraryLoadFailed: '产品加载失败，请稍后再试。', productLibraryRetry: '重试', productLibraryClearFilters: '清除筛选', quickFilterCategory: '按品类筛选', quickFilterSeries: '按系列筛选', allShort: '全部',
  ...
  en: {
    ...
    product_library: 'Product Library', productLibraryEmpty: 'No products yet', productLibraryEmptyHelp: 'The prompt-cms sync has not returned any products yet. Please try again shortly.', spec: 'Spec', sellingPoints: 'Selling points', productImages: 'Images', pasteImage: 'Paste image', dropImage: 'Drop image here', uploadImage: 'Upload image', uploadHint: 'Drag files, paste (⌘V), or click to choose', setCover: 'Set cover', removeCover: 'Remove cover', deleteImage: 'Delete', deleteConfirm: 'Delete this image?', uploading: 'Uploading…', coverBadge: 'Cover', noImagesPlaceholder: 'No images uploaded yet', viewGrid: 'Grid', viewTimeline: 'Timeline', viewToggleAria: 'View toggle', imageCountShort: 'img', imageCompression: 'Image compression', imageCompressionHelp: 'Default on; off=raw.', on: 'On', off: 'Off', productsShown: 'products', productsShownHelp: 'Total products in library', searchClear: 'Clear search',
    productLibraryNoResults: 'No matching products', productLibraryNoResultsHelp: 'Try a different keyword, clear filters, or add a new product.', productLibraryLoadFailed: 'Failed to load products. Please try again.', productLibraryRetry: 'Retry', productLibraryClearFilters: 'Clear filters', quickFilterCategory: 'Filter by category', quickFilterSeries: 'Filter by series', allShort: 'All',
