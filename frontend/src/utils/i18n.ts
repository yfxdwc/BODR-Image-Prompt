...
type TranslationKey =
  ...
  | 'imgInfo' | 'imgRatio' | 'imgSize' | 'imgPixels' | 'imgFormat' | 'searchClear' | 'searchHistory' | 'quickFilterCategory' | 'quickFilterSeries' | 'allShort' | 'noSearchHistory' | 'productsShown' | 'productsShownHelp';
...
const TRANSLATIONS: Record<UiLanguage, Record<TranslationKey, string>> = {
  ...
  zh_hans: {
    ...
    product_library: '产品库', productLibraryEmpty: '目前没有产品', productLibraryEmptyHelp: 'prompt-cms 同步尚未返回任何产品，请稍候再试。', spec: '规格', sellingPoints: '卖点', productImages: '图片', pasteImage: '粘贴图片', dropImage: '拖拽图片到此处', uploadImage: '上传图片', uploadHint: '可拖拽文件、粘贴 (⌘V)，或点击选择', setCover: '设为封面', removeCover: '取消封面', deleteImage: '删除', deleteConfirm: '删除这张图？', uploading: '上传中…', coverBadge: '封面', noImagesPlaceholder: '尚未上传任何图片', viewGrid: '网格', viewTimeline: '时间线', viewToggleAria: '视图切换', imageCountShort: '张', imageCompression: '上传压缩', imageCompressionHelp: '默认开，关则不重编码。', on: '开', off: '关', productsShown: '个产品', productsShownHelp: '产品库总数量', searchClear: '清除搜索', searchHistory: '搜索历史', quickFilterCategory: '按品类筛选', quickFilterSeries: '按系列筛选', allShort: '全部', noSearchHistory: '暂无搜索历史',
